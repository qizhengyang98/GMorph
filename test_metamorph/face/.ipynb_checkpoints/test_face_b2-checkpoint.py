...
emotionNet.load_state_dict(torch.load('pre_models/EmotionNet.model', map_location='cpu'))
...
genderNet.load_state_dict(torch.load('pre_models/genderNet.model', map_location='cpu'))
